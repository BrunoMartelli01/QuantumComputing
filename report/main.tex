...
Section \ref{sec:qkernel} presents our investigation into the parametrization of the construction of a quantum kernel in the context of gate-based architectures, with respect to a chosen dataset.
