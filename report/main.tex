...
\todo{aggiungere motivazione verso quantum HPC}
...
However, this superposition is lost upon measurement, which—according to the postulates of quantum mechanics—\todo{valutare citazione sul collasso dell'onda}causes the wave function to collapse into one of the two basis states.

Quantum kernel\todo{Citazione quantum kernel method} methods are based on the construction of a quantum circuit that is executed for each pair of input data points. 
